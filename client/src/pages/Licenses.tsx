...
export default function Licenses() {
  ...
  return <div className="min-h-screen bg-background"><PublicNav /><main className="container pt-28 pb-16">
    <Link href="/dashboard" className="text-sm underline">{t("licenses.back")}</Link>
    <h1 className="text-3xl font-sans mt-4 mb-2">{t("licenses.title")}</h1><p className="text-muted-foreground mb-8">{t("licenses.hint")}</p>
